# Plant Watcher
using the Mask R-CNN library, this library was created to see if plants could be identified and segmented on in order to provide pixel locations for a watering system. 

This repo is essentially a fork ATM, but will be pruned down to just the needed files later. 
